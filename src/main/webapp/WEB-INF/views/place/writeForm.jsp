                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="top-td">
                                        ...
                                        <input type="text" placeholder="ex)보라매 공원, 삼청동 카페 거리, 잠수교">
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                    ...
                                    <td>
                                        <input type="text" id="subway" placeholder="ex) 보라매, 종합운동장, 동작">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="hidden" id="level-val" value="">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <label id="write-label1"><input id="write-radio1" type="radio" name="storage" value="Y">가능</label>
                                            <label id="write-label2"><input id="write-radio2" type="radio" name="storage">불가능</label>
                                        </div>
                                        <div class="storage-place">
                                            짐 보관 장소 : <input type="text" placeholder="ex) ○○역 물품보관함, ○○스토어 무료 짐 보관">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
